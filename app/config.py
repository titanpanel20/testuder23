...
DEFAULT_SETTINGS = {
    ...
    # transport tuning (app/tuning.py) — server side is applied to the Xray config,
    # client side is baked into the generated config files (app/subfmt.py)
    "operator_profile": "general",
    "vision_enabled": True,
    "sockopt_enabled": True,
    "tcp_congestion": "bbr",
